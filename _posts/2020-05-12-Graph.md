...
For example, [Erdos-Renyi Random Graphs](../../../2020/05/15/Gnp) are good expander graphs with high expansion, while networks that have very clear clusters are usually not.


Furthermore, the expander graphs possess the following characteristics:

- The number of edges originating from every subset of vertices is larger than the number of vertices at least by a constant factor (more than 1).
...
- Small [eigengap](../../../2020/05/20/random-walks#) from its Laplacian Matrix or Adjacency Matrix
