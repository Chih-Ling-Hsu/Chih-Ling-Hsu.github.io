...
For the relationship between age and health status, we can see that the coefficient of $AGE\_15\_30$ also barely changes while the changes in the coefficient of $AGE\_7\_11$ and $AGE\_11\_15$ are both obvious, indicating that when adjusting for $GHb$, the relationship between age and health status changes.
