...
$$
(\|\overrightarrow{y_l}\| - \|\overrightarrow{x}\|)(\|\overrightarrow{y_i}\| - \|\overrightarrow{x}\|) > 0 ~\text{and}~\|\|\overrightarrow{y_l}\| - \|\overrightarrow{x}\|\| > \|\|\overrightarrow{y_i}\| - \|\overrightarrow{x}\|\|
\\
...
| $\because \|\overrightarrow{y_i}-\overrightarrow{y_j}\|$ | $\because \| \overrightarrow{y_i} \|_{l2}, \| \overrightarrow{y_i} \|_{\infty}, \| \overrightarrow{y_i} \|_{l1}$ | $\because Sum(\overrightarrow{y_i}), H(\overrightarrow{y_i}), V(\overrightarrow{y_i})$ | $\because \|\overrightarrow{y_i}\|$| 
